// src/components/domains/admin/ExerciseImport.tsx
"use client"
...
export function ExerciseImport() {
  ...
  const exerciseStatus = importProgress.exercises
  const isLoading = exerciseStatus.loading
  const result = exerciseStatus.result
  ...
  const handleFile = (file: File) => {
    ...
    importExercises(file)
  }

  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-medium">Exercise Import</h2>
        {result && (
        ...
        <div className="text-center">
          {isLoading ? (
            <div>
              ...
              <h3 className="text-lg font-medium mb-2">Importing exercises...</h3>
            ...
            <div>
              ...
              {result.errors.length > 0 && (
                <details className="mt-4 text-left">
                  <summary className="cursor-pointer text-[#B85C38] text-sm">
                    View Errors ({result.errors.length})
                  </summary>
                  <div className="mt-2 p-2 bg-[#B85C38]/10 rounded text-xs space-y-1">
            ...
            <div>
              ...
              <h3 className="text-lg font-medium mb-2">Upload Exercise CSV</h3>
              ...
              <p className="text-xs text-[#6B6B6B]">
                CSV should include: name, category, progressionLevel, description
              </p>
            </div>
          )}
        </div>
